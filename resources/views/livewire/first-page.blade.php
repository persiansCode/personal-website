@push("css")
<link rel="stylesheet" href="{{ asset("css/firstPage/style.css") }}">
...
<div class="grid grid-cols-12 place-items-center pt-18  px-[100px]">
   ...
   <div class="col-span-12 md:grid md:col-span-6 ">
        <img src="{{ asset("files/profile.jpg") }}" alt="" class="ink-blob-image ">
        <!-- #region --></div>
  <div class="col-span-12 md:col-span-6">
   ...
   <livewire:introduction/>  <div class="  border-b-[0.8px] mx-[10%] border-b-slate-400">
