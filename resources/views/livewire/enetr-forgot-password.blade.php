...
<div class=" grid grid-cols-12 pt-18 max-h-[100vh]  py-10 pl-10" dir="rtl">
    ...
    <div class="col-span-6">
        <img src="{{ asset("files/EnterForgotPassword.png") }}" class="rounded-md m-auto max-h-[92vh] w-[75%] " alt="">
    </div>
   <div class="col-span-6 my-auto ">
    ...
    <form action="">
     ...
     <x-auth.register.input title="ادرس ایمیل  " description="لطفا ادرس ایمیل خود را وارد نمایید"/>
          <x-auth.register.input title=" شماره تلفن  " description="لطفا شماره تلفن خود را وارد نمایید"/>
