...
<form id="form" wire:submit="submit" method="post"  enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-12 gap-3 " id="input-container" >
        ...
        <div class="col-span-12 md:col-span-5  text-slate-800  dark:text-platinum   md:col-start-1">
            ...
            <input wire:model="name"  value="<?php echo e(old('name' , $articleCategory->name )); ?>"  type="text" name="name" class="input input-md w-full bg-sage dark:bg-[#1d232a] " placeholder="لطفا تایپ کنید">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-span-12 md:col-span-5  text-slate-800  dark:text-platinum   ">
            ...
            <input type="text" name="description"  value="<?php echo e(old('description' , $articleCategory->description )); ?>" wire:model="description"  class="input input-md w-full bg-sage dark:bg-[#1d232a] " placeholder="لطفا تایپ کنید">
...
unset($__errorArgs, $__bag); ?>
    ...
    <input x-ref="selectElement"  value="<?php echo e(old('tags' , $articleCategory->tags )); ?>"  wire:model.lazy="tags" class="py-2  w-full" >
</div>
...
<?php /**PATH G:\programming\code\liara\resources\views\livewire\cms\article\edit-article-category.blade.php ENDPATH**/ ?>