...
unset($__defined_vars, $__key, $__value); ?>
   <div class="flex flex-col my-4 items-start p-2 rounded-md w-full  bg-[#222222]">
                <p class="text-gray-400 text-right mb-4  text-sm" dir="rtl"> <?php echo e($title); ?> </p>
                <input type="text" 
            ...
            >
            </div><?php /**PATH E:\programming\code\myProject\resources\views/components/auth/register/input.blade.php ENDPATH**/ ?>