...
<div class="pt-18  col-span-10 text-orange-400 px-2">
    ...
    <option value="1" <?php if($article->status==1 ): ?> selected <?php endif; ?> >فعال</option>
    <option value="0"  <?php if($article->status==0 ): ?> selected <?php endif; ?>>غیرفعال</option>
</select>
        </div>
...
unset($__errorArgs, $__bag); ?>
	...
	create: true
                    ...
                    <input x-ref="selectElement" wire:model.lazy="tags" value="<?php echo e($article->tags); ?>" class="">
                </div>
...
">
    ...
    <div class="col-span-12 md:col-span-10 text-slate-800 dark:text-platinum custom-select md:col-start-1" id="select2" dir="rtl">
        ...
        <textarea x-ref="ckeditor" id="editor1"  name="description"
            class="input input-md w-full" placeholder="لطفا تایپ کنید"><?php echo e($article->description); ?></textarea>
...
<script>
    ...
    ?><?php /**PATH G:\programming\code\liara\resources\views\livewire\cms\article\edit-articles.blade.php ENDPATH**/ ?>