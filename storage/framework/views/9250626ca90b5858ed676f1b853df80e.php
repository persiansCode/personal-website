...
<div class=" grid grid-cols-12 pt-18 max-h-[100vh]  py-10 pl-10" dir="rtl">
   ...
   <div class="col-span-6 my-auto ">
    ...
    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <input
            type="text"
            maxlength="1"
            id="<?php echo e($index); ?>"
...
<?php /**PATH G:\programming\code\liara\resources\views\livewire\enter-password.blade.php ENDPATH**/ ?>