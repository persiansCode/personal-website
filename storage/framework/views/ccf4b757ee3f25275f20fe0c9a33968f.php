...
<div class=" grid grid-cols-12 pt-18 max-h-[100vh]  py-10 pl-10" dir="rtl">
    ...
    <div class="col-span-6">
        <img src="<?php echo e(asset("files/forgotPassword.png")); ?>" class="rounded-md m-auto max-h-[92vh] w-[70%] " alt="">
    </div>
   <div class="col-span-6 my-auto ">
    ...
    <div class="pb-8">
        <p class="text-xl text-black dark:text-white" > رمز عبور خود را فراموش کرده اید؟ </p>
        <p class="text-sm py-3 text-black dark:text-white"> عبور عبور خود را تغییر دهید و سپس به سیستم وارد شوید </p>
    </div>
    <form action="">
...
</div><?php /**PATH G:\programming\code\liara\resources\views\livewire\forgot-password.blade.php ENDPATH**/ ?>