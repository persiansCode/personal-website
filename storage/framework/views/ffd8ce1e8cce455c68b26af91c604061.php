    ...
    <table class="w-full mt-10 border border-gray-500  rounded-md" style="border-collapse: separate;border-spacing:0px;">
        ...
        <tbody class="text-white">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="p-2">
                    <td class="p-2 text-center rounded-br-md"><?php echo e($item->id); ?></td>

                    <td>
                        <div class="flex justify-center">

                   
                             <?php if(file_exists(public_path($item->image['indexArray']['small']))): ?>
                           <img src="<?php echo e(asset($item->image['indexArray']['small'])); ?>"alt=""
                    ...
                    <td class="flex items-center p-2 justify-center gap-2">
                        ...
                        <p class="text-center"> <?php echo e($item->arthor->fullName() ?? '-'); ?> </p>
                    </td>
                    <td class="px-5">
                        <p class="text-center"> <?php echo e($item->title ?? '-'); ?> </p>
                    </td>
                    <td>
                    ...
                    <td class="">
                     ...
                     <td class="">
                        <div class="rounded-bl-md flex gap-2 justify-center items-center h-full">
                            <a href="<?php echo e(route('edit-article' , $item->id)); ?>" class="p-2 rounded-sm bg-orange-400 flex items-center justify-center  "><i
...
<?php /**PATH G:\programming\code\liara\resources\views\livewire\cms\article\show-articles.blade.php ENDPATH**/ ?>