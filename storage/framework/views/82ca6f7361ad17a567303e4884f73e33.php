...
$__html = app('livewire')->mount($__name, $__params, 'lw-3964438594-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3964438594-1', $__slots ?? [], get_defined_vars());
...
typewriter
  ...
  .typeString("برنامه نویس فول استک لاراول").pauseFor(300).start();
    ...
    ?>
<?php /**PATH G:\programming\code\liara\resources\views/livewire/first-page.blade.php ENDPATH**/ ?>